...
draw_text(room_width/2 - 300, room_height/2 - 270, "Player 1")
draw_set_color(c_red)
draw_text(room_width/2 - 300, room_height/2 - 240, player1)
draw_set_color(c_black)
draw_text(room_width/2 + 250, room_height/2 - 270, "Player 2")
draw_set_color(c_red)
draw_text(room_width/2 + 250, room_height/2 - 240, player2)
draw_set_color(c_black)
