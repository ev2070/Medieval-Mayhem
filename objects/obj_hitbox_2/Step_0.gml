...
if keyboard_check_pressed(ord("7")) {attack_type = "huntress";}
else if keyboard_check_pressed(ord("8")) {attack_type = "wizard";}
else if keyboard_check_pressed(ord("9")) {attack_type = "archer";}
else if keyboard_check_pressed(ord("0")) {attack_type = "worm";}
...
if !myPlayer.hit && !myPlayer.stun && myPlayer.charge_att { //charge att button released 
