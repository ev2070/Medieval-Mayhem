...
draw_text(454, 495, "Knight")


draw_text(761, 495, "Wizard")
...
draw_set_font(Font3)
draw_text(110, 145, "Use A (left) and D (right) buttons to choose an avatar")
draw_text(770, 145, "Use J (left) and L (right) buttons to choose an avatar")